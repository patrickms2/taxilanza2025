...
const EditControlpermisos = () => {
  ...
  const { controlpermisosId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: controlpermisosId }));
  }, [controlpermisosId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: controlpermisosId, data }));
...
EditControlpermisos.getLayout = function getLayout(page: ReactElement) {
  return <LayoutAuthenticated>{page}</LayoutAuthenticated>;
};

export default EditControlpermisos;

...
import { create } from '../../stores/departamentos/departamentosSlice';
...
DepartamentosNew.getLayout = function getLayout(page: ReactElement) {
  return <LayoutAuthenticated>{page}</LayoutAuthenticated>;
};

export default DepartamentosNew;

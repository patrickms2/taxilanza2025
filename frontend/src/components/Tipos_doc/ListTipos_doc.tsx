              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.patron}</p>
                  </div>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/tipos_doc/tipos_doc-edit/?id=${item.id}`}
                  pathView={`/tipos_doc/tipos_doc-view/?id=${item.id}`}
                  hasUpdatePermission={true}
                />
              </div>
            </CardBox>
          ))}
        {!loading && tipos_doc.length === 0 && (

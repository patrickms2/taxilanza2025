...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/pagos/pagosSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configurePagosCols';
...
const TableSamplePagos = ({
  ...
  useEffect(() => {
    if (pagosNotify.showNotification) {
      notify(pagosNotify.typeNotification, pagosNotify.textNotification);
    }
  }, [pagosNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/pagos/pagos-view/?id=${id}`);
  };
...
export default TableSamplePagos;

...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/citas/citasSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureCitasCols';
...
const TableSampleCitas = ({
  ...
  const {
    ...
    notify: citasNotify,
    refetch,
  } = useAppSelector((state) => state.citas);
  ...
  useEffect(() => {
    if (citasNotify.showNotification) {
      notify(citasNotify.typeNotification, citasNotify.textNotification);
    }
  }, [citasNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/citas/citas-view/?id=${id}`);
  };
...
export default TableSampleCitas;

              ...
              >
                ...
                >
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>id_estadistica</p>
                    <p className={'line-clamp-2'}>{item.id_estadistica}</p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.tipo_estadistica}</p>
                  </div>
...
export default ListEstadisticas;
